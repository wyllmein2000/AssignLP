...
solveLE::solveLE (double eps, double wns, int niter, int nm) {
   this->eps = eps;
   this->wns = wns;
   this->niter = niter;
   this->nm = nm;
...
void solveLE::cgstabilize (double *y, double *x) {
...
// Output: x=s=1/v
// ===================================================================
void solveLE::cgswy (double *x, double *x0, double *b, assign ass) {
...
// ===================================================================
void solveLE::cgsly (double *x, double *x0, double *b, assign ass) {
...
// ===================================================================
void solveLE::cgsmy (double *x, double *x0, double *b, double wns, double eps, int niter, int nm, void (*op)(double*, double*)) {
...
// ===================================================================
void solveLE::bcgswy (double *x, double *x0, double *b, double wns, double eps, int niter, int nm, void (*op)(double*, double*)) {
...
// ===================================================================
void solveLE::checkcgsop (int n, void (*op)(double*, double*)) {
...
// y=g'x
// ===================================================================
void solveLE::matadj (double *y, double *x) {
   for (int i=0; i<n; i++) {
       y[i]=0.0;
       for (int j=0; j<m; j++)
           y[i] += g[j][i]*x[j];
...
// ===================================================================
void solveLE::matop (double *y, double *x) {
